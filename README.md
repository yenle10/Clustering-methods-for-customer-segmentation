Goal of the project: We use machine learning clustering algorithms to analyze the spending behavior of credit card users. By applying algorithms we segment customers based on transaction patterns, purchase frequency, cash advances, credit usage..
